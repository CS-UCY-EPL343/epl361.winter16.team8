			...
			<div class="modal-content">
				...
				<div class = "row">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea class="form-control" id="ingredients" name="ingredients" placeholder="Please enter the ingredients here..." rows="10"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label" for="message">Execution:</label>
						<div class="col-md-9">
							<textarea class="form-control" id="message" name="message" placeholder="Please enter the execution here..." rows="5"></textarea>
						</div>
					</div>
					<div class="form-group">
