...
<html lang="en">
	<head>
		...
		<title>La Galerie | Products</title>
...
if ( $rowAd['ISADMIN']==1){
					...
					<div class = "row">
						<div  class="col-xs-12">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input id="title" name="title" type="text" placeholder="Insert Cakes Title" class="form-control">
								</div>
							</div>
							<!-- Message body -->
							<div class="form-group">
								...
								<div class="col-md-9">
									<textarea class="form-control" id="message" name="message" placeholder="Please enter your description here..." rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
	...
	document.getElementsByClassName("close").onclick = function() {
		modalAdd.style.display = "none";
				...
				//----------------------------
				echo '
							<h2 align="center"><a href="Categories.php">
				...
				while ($count < $rowcount) {
					...
					$loopResult = '
								<div class="col-sm-4">
									<div align="center">
										<a tabindex="-1" href="product.php?id2=' . $row2['PRODUCT_ID'] . '" style = "color:blue"> <img class="img-responsive" src="' . $row2['PICTURE'] . '" /> View details</a>
									</div>
								</div>
								';
					echo $loopResult;
