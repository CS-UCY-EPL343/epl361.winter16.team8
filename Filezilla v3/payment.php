												...
												<div class="pmt-mthds module">
													<fieldset>
														...
														<div class="pmt-mthd" data-pmt-id="PAYPAL" data-action-type="expandWallet" data-selected-pmt="true" data-incentive-dialog-id="incentive-dialog-data" data-click-id="7302">
															<div class="pmt-mthd-l v-align2col pointer">
																<div class="rdo-col-l v-align2col">
																	<input name="pmtMthd" id="PAYPAL" data-first-clickable="true" aria-label="Opens PayPal login window Select a payment option" checked="checked" type="radio">
																	<label class="pmt-label" for="PAYPAL"><span class="cc-icon mr8"></span>Log in to PayPal</label>
																</div>
															</div>
														</div>
														<br>
														<div class="pmt-mthd selected" data-pmt-id="CC" data-action-type="expandWallet" data-selected-pmt="true" data-incentive-dialog-id="incentive-dialog-data" data-click-id="7302">
															<div class="pmt-mthd-l v-align2col pointer">
																<div class="rdo-col-l v-align2col">
																	<input name="pmtMthd" id="CC" data-first-clickable="true" aria-label="JCC Select a payment option" checked="checked" type="radio">
																	<label class="pmt-label" for="CC"><span class="cc-icon mr8"></span>Log in to JCC</label>
																</div>
															</div>
														</div>
													</fieldset>
