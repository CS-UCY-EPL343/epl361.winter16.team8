	...
	<body>
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading"  style="color:white; "> About us and our patisserie.</h2>
					...
					<h3 class="featurette-heading"  style="color:white; ">What attracts customers to our Patisserie?</h3>
					<p class="lead" style="font-size: 16px; text-align: justify; color:white;" >
